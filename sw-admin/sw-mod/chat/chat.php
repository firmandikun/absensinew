...
<div class="chatbox">
   ...
   <div class="friendslist">
        ...
        <div class="search">
	         <input type="text" class="searchfield search-frendlist" placeholder="Search contacts pegawai.." value="">
         </div>
   </div>
   <!-- End Frend List -->
   ...
   <div class="chatview" style="display:none">
        ...
        <div class="sendmessage">
            <form class="form-add-chat" role="form" action="javascript:void(0);" autocomplete="off">
                ...
                <input type="text" class="emojioneArea" name="pesan" placeholder="Send message...">
