      ...
      <div class="container-fluid">
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <h6 class="h2 text-white d-inline-block mb-0">Posisi</h6>
        ...
        <div class="col">
          <div class="card pb-3">
            ...
            <div class="card-header mb-2">
              <h3 class="mt-2 mb-0 text-left float-left">Posisi</h3>
                ...
                <form class="form-add" role="form" action="#">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control posisi-nama" name="posisi_nama" required>
                        </div>
