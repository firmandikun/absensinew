...
if(!isset($_COOKIE['ADMIN_KEY']) && !isset($_COOKIE['KEY'])){
  ...
  if($result_role->num_rows > 0){
	...
	$_SESSION['KCFINDER']['uploadURL'] = "../../../sw-content/artikel/";
  switch(@$_GET['op']){ 
    default:
echo'
<!-- Header -->
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <h6 class="h2 text-white d-inline-block mb-0">Artikel</h6>
  ...
  <div class="header bg-primary pb-6">
    ...
    <div class="card">
      ...
      <div class="card-header">
        <h3 class="mb-0">Update Artikel</h3>
      </div>
      <!-- Card body -->
      <div class="card-body">';
                        ...
                        <div class="form-group">
                          ...
                          <div class="file-upload">
                              <div class="image-upload-wrap"  style="'.$imageuploadwrap.'">
                                ...
                                if(!$data_artikel['foto']== NULL){
                                  echo'<img src="../sw-content/artikel/thumbnail/'.strip_tags($data_artikel['foto']).'" class="file-upload-image" height="150">';
                                  }else{
