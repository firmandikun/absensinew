...
if(!isset($_COOKIE['ADMIN_KEY']) && !isset($_COOKIE['KEY'])){
  ...
  $query_role ="SELECT lihat,modifikasi,hapus FROM role WHERE modul_id='12' AND level_id='$current_user[level]'";
        ...
        <div class="col">
          <div class="card pb-3">
            ...
            <div class="card-header mb-2">
              <h3 class="mt-2 mb-0 text-left float-left">Slier</h3>
                ...
                <form class="form-add" role="form" action="#">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Judul</label>
                            <input type="text" class="form-control slider-nama" name="slider_nama" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control slider-url" name="slider_url" required>
                        </div>
