...
if(!isset($_COOKIE['ADMIN_KEY']) && !isset($_COOKIE['KEY'])){
  ...
  $query_role ="SELECT lihat,modifikasi,hapus FROM role WHERE modul_id='15' AND level_id='$current_user[level]'";
      ...
      <div class="container-fluid">
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <h6 class="h2 text-white d-inline-block mb-0">Hak Cuti</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-2">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="./"><i class="fas fa-home"></i> Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Hak Cuti</li>
                </ol>
              </nav>
            </div>
        ...
        <div class="col">
          <div class="card pb-3">
            ...
            <div class="card-header mb-2">
              <h3 class="mt-2 mb-0 text-left float-left">Hak Cuti</h3>
