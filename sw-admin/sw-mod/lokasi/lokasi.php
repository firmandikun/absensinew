          ...
          <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="lokasi_alamat" rows="2" required></textarea>
                </div>

                <div class="form-group">
                  <label class="form-control-label">Latitude</label>
                  <input type="text" class="form-control latitude" name="lokasi_latitude" required>
                </div>

                <div class="form-group">
                  <label class="form-control-label">Longitude</label>
                  <input type="text" class="form-control longitude" name="lokasi_longitude" required>
                </div>
                ...
                <div class="form-group">
                  <label class="form-control-label">Status Aktif</label><br>
            ...
            <div class="form-group">
              ...
              <div class="card">
                  <div id="MapLocation" style="height:460px"></div>
              </div>
            </div>
          </div>
    ...
    <div class="card">
      ...
      if($result_lokasi->num_rows > 0){
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
              <label class="form-control-label">Alamat Lengkap</label>
              <textarea class="form-control" name="lokasi_alamat" rows="2" required>'.strip_tags($data_lokasi['lokasi_alamat']).'</textarea>
            </div>

            <div class="form-group">
              <label class="form-control-label">Latitude</label>
              <input type="text" class="form-control latitude" name="lokasi_latitude" value="'.strip_tags($data_lokasi['lokasi_latitude']).'" required>
            </div>

            <div class="form-group">
              <label class="form-control-label">Longitude</label>
              <input type="text" class="form-control longitude" name="lokasi_longitude" value="'.strip_tags($data_lokasi['lokasi_longitude']).'" required>
            </div>
