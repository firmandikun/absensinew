            ...
            <div class="col-lg-3 order-lg-2">
              ...
              if($current_user['avatar']==''){
                ...
                <img class="rounded-circle img-140 view-image" src="./sw-assets/avatar/avatar.jpg">';
                  ...
                  echo'
                  <img src="data:image/gif;base64,'.base64_encode(file_get_contents('../sw-content/avatar/'.$current_user['avatar'].'')).'" class="rounded-circle img-140 view-image" height="140">';
                  }else{
                    echo'
                    <img class="rounded-circle img-140 view-image" src="../sw-content/avatar/avatar.jpg">';
                  }
                }
                echo'
                <span class="button">
