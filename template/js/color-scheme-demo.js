...
$(document).ready(function () {
    ...
    if ($.type($.cookie("stylesheet2")) != 'undefined' && $.cookie("stylesheet2") != '') {
        ...
        $('head').append('<link href="template/css/style-' + $.cookie('stylesheet2') + '.css" rel="stylesheet"  id="style">');
        setTimeout(function () {
            currentstyle.remove();
        }, 1000);
    ...
    $('.colorselect > input[type="radio"]').on('click', function () {
        ...
        if ($(this).is(':checked')) {
            ...
            $('head').append('<link href="template/css/style-' + setstyle + '.css" rel="stylesheet"  id="style">');
            setTimeout(function () {
                currentstyle.remove();
            }, 1000);
