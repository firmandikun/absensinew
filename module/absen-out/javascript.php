        ...
        if($data_setting_absen['radius'] =='Y'){
            ...
            <script type="text/javascript">
                ...
                if (<?php echo $lokasi_radius;?> > jarak){
                    ...
                    "reader", {fps: 10, qrbox: {width: 230, height: 230},facingMode: "environment"});
                    ...
                    function onScanSuccess(decodedText, decodedResult) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "./module/absen-out/sw-proses.php?action=absen-qrcode-radius",
                            data: dataString,
                            cache: false,
                            async: false,
                ...
                <script type="text/javascript">
                    ...
                    $("#webcam-switch").change(function () {
                        ...
                        function insert(){
                            ...
                            $.ajax({
                                type: "POST",
                                url: "./module/absen-out/sw-proses.php?action=absen-selfie-radius",
